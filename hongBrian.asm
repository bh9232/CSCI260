...
check:
#if m is zero
beq $s0,0,end		#if m=0 goto end (immpossible to have 2 squares and diagonals)
#if n is zero
beq $s1,0,end		#if n=0 goto end (immpossible to have 2 squares and diagonals)
#if m = n
beq $s0,$s1,end		#if m=n goto end (immpossible to have 2 squares and diagonals)
#if m is odd
